         ...
         {/* Left Side */}
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 leading-tight whitespace-nowrap overflow-hidden">
            ...
            <span className="text-[#8245ec] inline-block">
              <Typewriter
                options={{
                  strings: ['Fullstack Developer', 'Data Analytics', 'UI/UX Designer', 'Coder'],
                  autoStart: true,
                  loop: true,
                  delay: 75,
                  deleteSpeed: 55,
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1oCPRMuLQ62ZURTb8ePeFVCfIG5o6R0N6/view?usp=sharing"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block text-white py-3 px-8 rounded-full mt-5 text-lg font-bold transition duration-300 transform hover:scale-105"
            style={{
              background: 'linear-gradient(90deg, #8245ec, #a855f7)',
              boxShadow: '0 0 1px #8245ec, 0 0 2px #8245ec, 0 0 10px #8245ec',
            }}
          >
            DOWNLOAD CV
          </a>
